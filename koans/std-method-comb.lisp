...
(define-test salary-at-company-a
  ...
  (let ((programmer (make-instance 'senior-programmer)))
    (assert-equal (+ 120000 200000) (salary-at-company-a programmer)))
  (let ((programmer (make-instance 'full-stack-programmer)))
    (assert-equal (+ 120000 48000) (salary-at-company-a programmer)))
  (let ((programmer (make-instance 'senior-full-stack-programmer)))
    (assert-equal (+ 120000 200000 48000) (salary-at-company-a programmer))))
...
(define-test salary-at-company-b
  (let ((programmer (make-instance 'programmer)))
    (assert-equal (* 1 120000) (salary-at-company-b programmer)))
  (let ((programmer (make-instance 'senior-programmer)))
    (assert-equal (* 1 120000 2) (salary-at-company-b programmer)))
  (let ((programmer (make-instance 'full-stack-programmer)))
    (assert-equal (* 1 120000 7/5) (salary-at-company-b programmer)))
  (let ((programmer (make-instance 'senior-full-stack-programmer)))
    (assert-equal (* 1 120000 2 7/5) (salary-at-company-b programmer))))
